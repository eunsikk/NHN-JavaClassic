...
class CreateAccount {
    ...
    public static void TestDeposit(BankAccount account) {
        ...
        BigDecimal amount = new BigDecimal(scanner.next("1000"));
    ...
    public static void TestWithDraw(BankAccount account) {
        ...
        BigDecimal amount = new BigDecimal(scanner.next("500"));
    ...
    public static void main(String[] args) {
        BankAccount bankAccount =
                CreateAccount.createNewBankAccount("Vesper Lind", new BigDecimal("1000"));
        ...
        BankAccount bankAccount2 =
                CreateAccount.createNewBankAccount("Celine ", new BigDecimal("5000"));
